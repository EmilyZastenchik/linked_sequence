...
#include "sequence3d.h"  // With value_type defined as double
using namespace std;
...
int main()
{
	sequence test; // A sequence that we値l perform tests on
...
// Library facilities used: iostream.h
{
	...
	cout << " A   append a new number with the append(...) function" << endl;
